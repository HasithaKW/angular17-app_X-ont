// ============================================================
// AuthController.cs
// ADD THIS FILE TO: XONT.VENTURA.SOMNT24.WEB / Controllers /
//
// This replaces the old Global.asax Session_Start that hardcoded:
//   Session["Main_LoginUser"]    = _user
//   Session["Main_BusinessUnit"] = "LUCK"
//   Session["Main_UserName"]     = "xontadmin"
//
// Now Angular POSTs credentials → this controller validates them
// → sets the same Session[] keys → returns user info as JSON.
//
// Your Program.cs already has AddSession() + UseSession() so
// Session works as normal. No JWT, no extra packages needed.
// ============================================================
